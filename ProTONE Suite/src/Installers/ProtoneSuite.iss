...
;--------------------------------------
; Translation files
Source: "{#BINDIR}\Translations\OPMedia.ProTONE-en.json"; DestDir: "{app}\Translations"
Source: "{#BINDIR}\Translations\OPMedia.ProTONE-de.json"; DestDir: "{app}\Translations"
Source: "{#BINDIR}\Translations\OPMedia.ProTONE-ro.json"; DestDir: "{app}\Translations"
Source: "{#BINDIR}\Translations\OPMedia.ProTONE-fr.json"; DestDir: "{app}\Translations"
Source: "{#BINDIR}\Translations\OPMedia.MediaLibrary-en.json"; DestDir: "{app}\Translations"
...
Source: "{#BINDIR}\System.Threading.Tasks.Extensions.dll"; DestDir: "{app}"; Flags: replacesameversion uninsremovereadonly promptifolder uninsrestartdelete touch restartreplace
;--------------------------------------
; EXE config files
Source: "{#BINDIR}\OPMedia.AudioCdWorker.exe.config"; DestDir: "{app}"; Flags: replacesameversion uninsremovereadonly promptifolder uninsrestartdelete touch restartreplace
...
[Components]
Name: "itemPlayer"; Description: "{cm:itemPlayer}"; Types: default; Flags: fixed checkablealone
Name: "itemPlayer\itemLibrary"; Description: "{cm:itemLibrary}"; Types: default; Flags: dontinheritcheck
Name: "itemCodecs"; Description: "{cm:itemCodecs}"; Types: default; Flags: fixed checkablealone; Check: CodecsAreMissing
Name: "itemCodecs\itemFFDShow"; Description: "{cm:itemFfdShow}"; Types: default; Flags: checkablealone; Check: FFDShowIsMissing
Name: "itemCodecs\itemHaali"; Description: "{cm:itemHDSupport}"; Types: default; Flags: checkablealone; Check: HaaliIsMissing
...
Root: HKCU; SubKey: Software\GNU\ffdshow\default; ValueType: dword; ValueName: isSubtitles; ValueData: $00000000; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow\default; ValueType: dword; ValueName: fontCharset; ValueData: $00000001; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow\default; ValueType: dword; ValueName: fontSizeA; ValueData: $00000016; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow\default; ValueType: dword; ValueName: fontColor; ValueData: $00ffffff; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow\default; ValueType: dword; ValueName: OSDfontSize; ValueData: $00000016; Components: itemCodecs\itemFFDShow
Root: HKCU; SubKey: Software\GNU\ffdshow\default; ValueType: dword; ValueName: OSDfontWeight; ValueData: $000002bc; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow\default; ValueType: dword; ValueName: OSDfontColor; ValueData: $00ffffff; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow; ValueType: dword; ValueName: lastPage; ValueData: $03200071; Components: itemCodecs\itemFFDShow
Root: HKCU; SubKey: Software\GNU\ffdshow; ValueType: dword; ValueName: dlgPosX; ValueData: $000000cd; Components: itemCodecs\itemFFDShow
Root: HKCU; SubKey: Software\GNU\ffdshow; ValueType: dword; ValueName: lvCodecsSelected; ValueData: $00000012; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow; ValueType: dword; ValueName: dlgPosY; ValueData: $00000119; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow_audio; ValueType: dword; ValueName: mp2; ValueData: $00000007; Components: itemCodecs\itemFFDShow
Root: HKCU; SubKey: Software\GNU\ffdshow_audio; ValueType: dword; ValueName: mp3; ValueData: $00000007; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow_audio; ValueType: dword; ValueName: lvCodecsSelected; ValueData: $00000001; Components: itemCodecs\itemFFDShow
...
Root: HKCU; SubKey: Software\GNU\ffdshow_audio; ValueType: dword; ValueName: dlgPosY; ValueData: $0000015d; Components: itemCodecs\itemFFDShow
