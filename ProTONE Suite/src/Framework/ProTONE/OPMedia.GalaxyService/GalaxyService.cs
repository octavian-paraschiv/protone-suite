...
{
    public partial class GalaxyService : ServiceBase
    {
        ...
        {
            InitializeComponent();
            this.ServiceName = Constants.GalaxyServiceShortName;
        }
        ...
        static void Main()
        {
            if (Environment.UserInteractive)
            {
                ...
                new GalaxyService().RunStandAlone(Environment.GetCommandLineArgs());
            }
            else
            {
                // Start as Windows Service
                Run(new GalaxyService());
            }
        }
