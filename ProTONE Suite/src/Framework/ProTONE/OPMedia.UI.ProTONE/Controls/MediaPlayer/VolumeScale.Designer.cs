...
namespace OPMedia.UI.ProTONE.Controls.MediaPlayer
{
    partial class VolumeScale
    {
        ...
        {
            this.layoutPanel1 = new OPMedia.UI.Controls.OPMTableLayoutPanel();
            this.lblMax = new OPMedia.UI.Controls.OPMLabel();
            this.volumeProgress = new OPMedia.UI.Controls.ControlGauge();
            this.lblMin = new OPMedia.UI.Controls.OPMLabel();
            this.lblCurrent = new OPMedia.UI.Controls.OPMLabel();
