...
namespace OPMedia.UI.Controls
{
	...
	{	
		...
		public OPMListViewSubItem(ListViewItem owner, string text) : 
			base(owner, text)
		{
			readOnly = true;
			IsValid = true;
		...
		/// <param name="owner">The owner of the subitem.</param>
		/// <param name="text">The text to be displayed.</param>
		public OPMListViewSubItem(Control editControl, 
			...
			base(owner, text)
		{
            ...
            //if (owner.ListView != editControl.Parent)
            //{
            //    owner.ListView.SuspendLayout();
            //    editControl.Parent = owner.ListView;
            //    editControl.Visible = false;
            //    owner.ListView.ResumeLayout();
            //}
		}
		#endregion
	}
