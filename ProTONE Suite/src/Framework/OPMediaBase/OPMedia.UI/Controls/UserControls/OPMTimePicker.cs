...
namespace OPMedia.UI.Controls
{
    ...
    public partial class OPMTimePicker : UserControl
    {
        private static ImageList _il = null;

        static OPMTimePicker()
        {
            _il = new ImageList();
            _il.ImageSize = new Size(8, 8);
            _il.TransparentColor = Color.Magenta;
            _il.ColorDepth = ColorDepth.Depth4Bit;
            _il.Images.Add(Resources.ilUp);
            _il.Images.Add(Resources.ilDn);
        }
        ...
        public OPMTimePicker()
        {
            InitializeComponent();

            btnPlus.ImageList = _il;
            btnMinus.ImageList = _il;

            btnPlus.ImageIndex = 0;
            btnMinus.ImageIndex = 1;

            btnPlus.Click += new EventHandler(OnPlus);
            btnMinus.Click += new EventHandler(OnMinus);
        ...
        {
            KeyEventArgs ke = new KeyEventArgs(Keys.Down);
