...
namespace OPMedia.Runtime.ProTONE.Utilities
{
    ...
    public static class RegistrationSupport
    {
        ...
        static RegistrationSupport()
        {
            ...
            _launchPaths.Add(KnownFileType.Playlist, ShellProTONEConfig.PlayerInstallationPath);
            _launchPaths.Add(KnownFileType.Bookmark, ShellProTONEConfig.PlayerInstallationPath);
            _launchPaths.Add(KnownFileType.Catalog, ShellProTONEConfig.LibraryInstallationPath);
            ...
            _descriptions.Add(KnownFileType.Bookmark, ShellConstants.BookmarkFileTypeDesc);
            _descriptions.Add(KnownFileType.Catalog, ShellConstants.CatalogFileTypeDesc);
                ...
                //if (regMediaType)
                {
                    ...
                    using (RegistryKey mediaTypeKey = Registry.ClassesRoot.CreateSubKey(info.MediaType))
                    {
                        ...
                        using (RegistryKey defaultIconKey = mediaTypeKey.CreateSubKey("DefaultIcon"))
                        {
                            ...
                            {
                                string newValue = string.Format(@"{0}\Resources\{1}.ico", LiteAppConfig.InstallationPath, info.KnownFileType);
        ...
        public static void RegisterContextMenuHandler()
        {
            ...
            string keyName = @"*\shellex\ContextMenuHandlers\" + ShellSupport.ShellConstants.PlayerName;
            using (RegistryKey key = Registry.ClassesRoot.CreateSubKey(keyName))
            {
                // Set the default value of the key.
                if (key != null)
                {
                    key.SetValue(null, ShellSupport.ShellConstants.CanonicShellIntegrationSuportGuid);
                }
            }

            // Folder context menu handler
            keyName = @"Directory\shellex\ContextMenuHandlers\" + ShellSupport.ShellConstants.PlayerName;
            using (RegistryKey key = Registry.ClassesRoot.CreateSubKey(keyName))
            {
                // Set the default value of the key.
                if (key != null)
            ...
            keyName = @"Drive\shellex\ContextMenuHandlers\" + ShellSupport.ShellConstants.PlayerName;
            using (RegistryKey key = Registry.ClassesRoot.CreateSubKey(keyName))
            {
                // Set the default value of the key.
                if (key != null)
        ...
        public static void UnregisterContextMenuHandler()
        {
            ...
            try
            {
                Registry.ClassesRoot.DeleteSubKeyTree(@"*\shellex\ContextMenuHandlers\" + ShellSupport.ShellConstants.PlayerName);
            }
            catch { }
            ...
            try
            {
                Registry.ClassesRoot.DeleteSubKeyTree(@"Directory\shellex\ContextMenuHandlers\" + ShellSupport.ShellConstants.PlayerName);
            }
            catch { }
            ...
            try
            {
                Registry.ClassesRoot.DeleteSubKeyTree(@"Drive\shellex\ContextMenuHandlers\" + ShellSupport.ShellConstants.PlayerName);
            }
            catch { }
        }
        ...
        public static bool IsContextMenuHandlerRegistered()
        {
            try
            {
                ...
                using (RegistryKey key = Registry.ClassesRoot.OpenSubKey(@"*\shellex\ContextMenuHandlers\" + ShellSupport.ShellConstants.PlayerName))
                {
                    if (key != null)
                    {
                ...
                using (RegistryKey key = Registry.ClassesRoot.OpenSubKey(@"Directory\shellex\ContextMenuHandlers\" + ShellSupport.ShellConstants.PlayerName))
                {
                    if (key != null)
                    {
                ...
                return (fileHandlerGuid == folderHandlerGuid && folderHandlerGuid == ShellSupport.ShellConstants.CanonicShellIntegrationSuportGuid);
            }
            catch
            {
                return false;
        ...
        {
            DllImports.SHChangeNotify(HChangeNotifyEventID.SHCNE_ASSOCCHANGED,
